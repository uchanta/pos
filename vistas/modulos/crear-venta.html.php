        ...
        <div class="box box-success">
          ...
          <form role="form" method="post">
              ...
              <div class="box"></div>
                ...
                <div class="form-group">
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="nuevaVenta" name="nuevaVenta" value="1000123" readonly>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <!-- ===========================================
                  BOTON IMPUESTO EN PRECIO TOTAL
                  =============================================-->
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-default btn-primary pull-right">Guardar venta</button>
            </div>
                ...
                <table class="table table-bordered table-striped dt-responsive tablas">
                  ...
                  <tbody>
                    ...
                    <td>1.</td>
                      ...
                      <td>
                        <div class="btn-goup">
                          <buton type="button" class="btn btn-primary">Agregar</buton>
                        </div>
                      </td>
                    </tr>
                  </tbody>
